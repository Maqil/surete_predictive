...
import { ReactComponent as AgriculteurSvg } from "../../layouts/img/agriculteur.svg";
import { ReactComponent as LaboratoiresSvg } from "../../layouts/img/laboratoires.svg";
      ...
      <AppBar position="fixed" className={classes.appbar}>
        <Toolbar>
          ...
          >
            ...
            />
            <StyledTab
              icon={<LaboratoiresSvg />}
              label=" Laboratoires"
              {...a11yProps(3)}
            />
            <StyledTab icon={<LotsSvg />} label="Lots" {...a11yProps(4)} />
          </StyledTabs>
          ...
          <div className={classes.sectionDesktop}>
            ...
            <Typography component={"span"}>
              <div style={{ width: 170, paddingTop: 12 }}>
                <div className={classes.user}>Abdellah Hamma</div>
                <div className={classes.admin}>ADMIN OCP</div>
              </div>
            </Typography>
